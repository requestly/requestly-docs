...
visibility: PUBLIC
---
Simulate a failed response on the first request and a successful one on subsequent attempts using [shared state](/general/http-rules/advanced-usage/shared-state) in Requestly Interceptor.
