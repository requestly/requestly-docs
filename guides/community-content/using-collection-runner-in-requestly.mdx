...
That's where Requestly's Collection Runner shines. In this guide, I'll walk you through how I explored the Collection Runner feature, how it simplifies API automation, and how you can start using it right away — even if you're completely new to automated API testing.
...
I started by opening the Requestly app → going to **APIs** → **New** → and clicking **Collection**. You can also import a pre-existing API collection by clicking the **Import** button.
...
![Setting Up](/images/using-collection-runner-in-requestly/image1.png)
...
![Scripts](/images/using-collection-runner-in-requestly/image2.png)
...
![Collection Runner](/images/using-collection-runner-in-requestly/image3.png)
...
![Reordering](/images/using-collection-runner-in-requestly/image4.png)

After setting everything up, I hit **Run Collection** — and boom! Requestly started running all my requests in order, one after another, while I just watched it go.

![Collection-Running](/images/using-collection-runner-in-requestly/image5.png)
...
![Variables](/images/using-collection-runner-in-requestly/image6.png)
...
![Final Tests](/images/using-collection-runner-in-requestly/image7.png)
...
It's basically like having a mini continuous testing pipeline, right inside Requestly — but without the complexity of CI/CD setup.
...
- [Requestly Documentation — Collection Runner](https://docs.requestly.com)
