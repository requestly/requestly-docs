...
**Requestly's Local Workspace** Track changes to your API collections and any mock files created inside the API Client. When you connect it with **Git**, you get all the benefits of version control:

- ✅ **Track changes** to your API collections and mock files.
...
4. Choose a folder on your system where your workspace files will be stored
...
### **Step 2: Build Your API Collection**

Now that your workspace is set up, let's populate it with some content:

1. Navigate to your newly created workspace
2. Create API collections or mock responses as needed
3. Save your changes within the Requestly interface
...
1. **Create a New Repository on GitHub**
   ...
   - Copy the repository URL (you'll need it in step 6)
