...
**Requestly's Local Workspace** Track changes to your API collections and Requests created inside the API Client. When you connect it with **Git**, you get all the benefits of version control:

- ✅ **Track changes** to your API collections.
...
2. Create API collections or APIs as needed
