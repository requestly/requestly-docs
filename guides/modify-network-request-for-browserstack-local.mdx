---
title: "Requestly Integration with BrowserStack App Live"
label: "Requestly Integration with BrowserStack App Live"
slug: "requestly-integration-browserstack-app-live"
description: "Learn how to use Requestly with BrowserStack App Live to inspect and modify network requests by configuring BrowserStack Local and system proxy settings."
visibility: "PUBLIC"
---
...
You should now be able to see all the requests from your app session running inside browserstack. You can also modify these requests using [Requestly Rules](/general/http-rules/overview) and see them take effect inside the App Live session.