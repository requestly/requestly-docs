...
You should now be able to see all the requests from your app session running inside browserstack. You can also modify these requests using [Requestly Interceptor Rules](/general/http-rules/overview) and see them take effect inside the App Live session.