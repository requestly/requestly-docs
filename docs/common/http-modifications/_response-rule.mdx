...
## Create rule for different resource types
...
- Rest API
- Graphql API (Apply Request Payload Filter)
- HTML / JS / CSS (Available in Desktop app)
...
## Targeting GraphQL request using operation name

For graphql request add operation name and value to modify the response.
