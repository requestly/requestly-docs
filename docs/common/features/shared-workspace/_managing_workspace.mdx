...
![manage workspace](/img/docs/team-workspace/manage-workspace.png)
...
![add members](/img/docs/team-workspace/add-members.png)

An invite will be sent to the emails that you enter here
![email invite](/img/docs/team-workspace/enter-emails.png)
...
![remove members](/img/docs/team-workspace/remove-member.png)
