...
1. **Resource Override Chrome Extension Importer**\
   Introduced the ability to import configurations directly from Resource Override Chrome Extension, making it easier to transition. Refer [docs](/http-interception/imports/resource-override).
