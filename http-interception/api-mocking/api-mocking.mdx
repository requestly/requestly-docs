...
For detailed instructions on setting up Local Mocks and Modify Response, visit our [Local Mocks Documentation](/http-interception/api-mocking/create-local-api-mocks).
...
For step-by-step instructions on creating and managing Cloud Mocks, visit our [Cloud Mocks Documentation](/http-interception/api-mocking/create-cloud-based-mocks).
