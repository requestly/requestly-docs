...
If you already know exactly how you want to change traffic, go to [HTTP Rules](/http-interception/http-rules/overview).

## Choose Your Interception Setup

<CardGroup cols={2}>
  <Card title="Browser Extension" icon="browser" href="/http-interception/interceptor/browser-extension/browser-interception">
    Best for browser-only workflows and the fastest setup.
  </Card>
  <Card title="Desktop App" icon="desktop" href="/http-interception/interceptor/desktop-app">
...
<Steps>
  ...
  <Step title="Confirm Traffic Is Visible">
    Open the [network table](/http-interception/interceptor/desktop-app/network-table) or browser interception view and verify requests appear before moving on to rules or mocks.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Desktop Browsers" href="/http-interception/interceptor/desktop-app/browser-interception" icon="globe">
    Connect Chrome, Firefox, Edge, and similar browsers through the Desktop App.
  </Card>
  <Card title="Android Devices" href="/http-interception/interceptor/desktop-app/android-devices" icon="mobile-screen">
    Intercept traffic from Android phones and tablets.
  </Card>
  <Card title="Android Emulators" href="/http-interception/interceptor/desktop-app/android-simulator-interception" icon="mobile">
    Capture traffic from Android Studio emulators.
  </Card>
  <Card title="iOS Devices & Simulators" href="/http-interception/interceptor/desktop-app/ios-devices-interception" icon="mobile-notch">
    Set up iPhones, iPads, and iOS simulators.
  </Card>
  <Card title="Node.js" href="/http-interception/interceptor/desktop-app/nodejs" icon="terminal">
    Debug server-side requests from Node.js applications.
  </Card>
  <Card title="Terminal & CLI Tools" href="/http-interception/interceptor/desktop-app/terminal" icon="square-terminal">
...
<CardGroup cols={2}>
  <Card title="Create Rules" href="/http-interception/http-rules/overview" icon="wand-magic-sparkles">
    Modify intercepted traffic once you know what needs to change.
  </Card>
  <Card title="Capture Sessions" href="/http-interception/sessions/overview" icon="camera">
    Save traffic and debugging context for sharing, replaying, or mock creation.
  </Card>
  <Card title="Import HAR Files" href="/http-interception/sessions/import-view-har-file" icon="file-import">
    Analyze previously captured network data inside Requestly Interceptor.
  </Card>
  <Card title="Fix Interception Issues" href="/http-interception/troubleshoot/http-interceptor/unable-to-intercept-web-traffic-on-browser-mobile-or-emulator" icon="wrench">
