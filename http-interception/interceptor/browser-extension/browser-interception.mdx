  ...
  <Tab title="Network Traffic">
    <Tabs>
      <Tab title="Network Traffic">
        ...
        <Note>
          If you want to intercept traffic from another browser extension, please use the [Requestly Interceptor Desktop App](https://docs.requestly.com/http-interception/interceptor/desktop-app#desktop-app) instead.
        </Note>
