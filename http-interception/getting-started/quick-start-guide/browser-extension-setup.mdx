...
Each area has its own documentation—use the sidebar to explore Network Inspector, HTTP Rules, Sessions, and Mock Server.
...
Use the [Desktop App setup](/http-interception/getting-started/quick-start-guide/desktop-app-setup) instead if you need mobile, emulator, terminal, Node.js, or system-wide interception.

## Recommended Next Steps

<CardGroup cols={2}>
  <Card title="Getting Started Overview" href="/http-interception/getting-started/overview" icon="rocket">
    Choose a path and complete setup for interception-focused workflows.
  </Card>
  <Card title="Inspect Browser Traffic" href="/http-interception/interceptor/browser-extension/browser-interception" icon="magnifying-glass">
    Learn how interception works inside the browser extension.
  </Card>
  <Card title="Create Your First HTTP Rule" href="/http-interception/http-rules/rule-types" icon="wand-magic-sparkles">
    Modify headers, redirect URLs, or rewrite responses without changing application code.
  </Card>
  <Card title="Troubleshoot Browser Setup" href="/http-interception/troubleshoot/http-rules/rules-not-working" icon="wrench">
