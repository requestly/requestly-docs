...
If you only need browser-based interception and a lighter setup, start with the [Browser Extension setup](/http-interception/getting-started/quick-start-guide/browser-extension-setup).
...
<CardGroup cols={2}>
  ...
  <Card title="Capture API Sessions" href="/http-interception/sessions/record-api-sessions" icon="camera">
    Record requests and responses you can analyze, replay, or share.
  </Card>
  <Card title="Create Rules Or Mocks" href="/http-interception/http-rules/overview" icon="wand-magic-sparkles">
    Use captured traffic to modify, replay, or mock backend behavior.
  </Card>
  <Card title="Troubleshoot Interception" href="/http-interception/troubleshoot/http-interceptor/unable-to-intercept-web-traffic-on-browser-mobile-or-emulator" icon="wrench">
