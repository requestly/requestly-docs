...
<CardGroup cols={2}>
  <Card
    ...
    href="/http-interception/getting-started/overview"
    icon="rocket"
  >
  ...
  <Card
    ...
    href="/http-interception/getting-started/quick-start-guide/browser-extension-setup"
    icon="browser"
  >
  ...
  <Card
    ...
    href="/http-interception/getting-started/quick-start-guide/desktop-app-setup"
    icon="desktop"
  >
