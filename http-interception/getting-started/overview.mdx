...
Use [API Mocking](/http-interception/api-mocking/api-mocking) and [Mock Server](/http-interception/mock-server/overview) to simulate backend behavior for development, testing, demos, and failure scenarios.
...
<Tip>
  Still deciding? Read [how the Browser Extension differs from the Desktop App](/account/how-is-bowser-extension-different-from-a-desktop-app).
</Tip>
