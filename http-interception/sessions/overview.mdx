...
<Tabs>
  <Tab title="Record Bug Reports">
    ...
    <Card title="Record Bug Reports" icon="bug" href="/http-interception/sessions/record-bug-reports">
  ...
  <Tab title="Capture API Sessions">
    ...
    <Card title="Capture API Sessions" icon="network-wired" href="/http-interception/sessions/record-api-sessions">
...
<Steps>
  ...
  <Step title="Capture The Session">
    Use [Record Bug Reports](/http-interception/sessions/record-bug-reports) or [Record API Sessions](/http-interception/sessions/record-api-sessions) depending on the workflow.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Import HAR Files" icon="file-import" href="/http-interception/sessions/import-view-har-file">
    Open and analyze existing HAR files in Requestly Interceptor.
  </Card>
  <Card title="Access Control" icon="lock" href="/http-interception/sessions/access-control-of-session">
    Control who can view and use shared sessions.
  </Card>
  <Card title="Inspect Traffic First" icon="magnifying-glass" href="/http-interception/interceptor/overview">
    Start with HTTP Interceptor if you need to capture traffic before recording a reusable session.
  </Card>
  <Card title="Mock From Captured Traffic" icon="wand-magic-sparkles" href="/http-interception/guides/record-and-mock-flaky-apis-in-bulk">
