...
If your goal is to inspect live traffic first, use [HTTP Interceptor](/http-interception/interceptor/overview). If you need hosted mock endpoints, use [Mock Server](/http-interception/mock-server/overview).
