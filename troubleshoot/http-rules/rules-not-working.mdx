...
description: "Having trouble with your rules? Follow this step-by-step checklist to quickly identify and resolve common issues with the Requestly browser extension."
visibility: "PUBLIC"
---
...
<CardGroup cols={2}>
  <Card title="Review HTTP Rules Overview" href="/general/http-rules/overview" icon="wand-magic-sparkles">
    Revisit when to use each rule type and the recommended first workflows.
  </Card>
  <Card title="Inspect Traffic First" href="/general/http-interceptor/overview" icon="magnifying-glass">
  ...
  <Card title="Use The Desktop App" href="/general/getting-started/quick-start-guide/desktop-app-setup" icon="desktop">
