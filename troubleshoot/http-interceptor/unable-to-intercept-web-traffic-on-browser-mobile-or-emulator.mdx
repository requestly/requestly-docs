...
<CardGroup cols={2}>
  ...
  <Card title="Browser Or App Is Not Showing Any Traffic" href="/general/http-interceptor/desktop-app/browser-interception" icon="browser">
    Revisit the matching browser or runtime setup path first.
  </Card>
  <Card title="Mobile Device Or Emulator Is Connected But Empty" href="/general/http-interceptor/desktop-app/android-devices" icon="mobile-screen">
