...
visibility: PUBLIC
---
Requestly Interceptor Mock Server lets you host reusable mock endpoints and static assets for testing, demos, and development workflows.
...
<CardGroup cols={2}>
  ...
  <Card title="Import And Export Mocks" icon="download" href="/general/mock-server/import-and-export-mocks">
    Move mocks between workflows and share them more easily.
  </Card>
  <Card title="Quick Local Mocking" icon="bolt" href="/general/api-mocking/api-mocking">
    Start with local or cloud-based quick mocks when you do not need a full hosted mock server.
  </Card>
  <Card title="Redirect Traffic To A Mock" icon="shuffle" href="/general/http-rules/rule-types/redirect-rule">
