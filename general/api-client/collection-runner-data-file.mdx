...
<Steps>
  <Step title="Open Collection Runner">
    ...
    ![Data File Supportincollection Runner(runcollection) Pn](/images/DataFileSupportincollectionRunner\(runcollection\).png)
  </Step>
  <Step title="Select a Data File">
    ...
    ![Data Filesupportin Collection Runner(addfile) Pn](/images/DataFilesupportinCollectionRunner\(addfile\).png)
  ...
  <Step title="Preview Data and Map Variables">
    ...
    ![Datafilesupportfor Collection Runner(preview) Pn](/images/DatafilesupportforCollectionRunner\(preview\).png)
  ...
  <Step title="Start the Run">
    ...
    ![Data Supportin Collection Runner(save&run) Pn](/images/DataSupportinCollectionRunner\(save&run\).png)
  </Step>
</Steps>
