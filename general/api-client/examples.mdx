---
title: "Create examples of request responses"
...
Examples allow you to save reusable snapshots of an API request with specific configurations such as parameters, headers, and body payloads. This makes it easy to switch between different variations of the same request without modifying the original.
