...
Examples let you save complete snapshots of an API call, including the request configuration and its corresponding response. This allows you to quickly switch between different scenarios without modifying the original request.
