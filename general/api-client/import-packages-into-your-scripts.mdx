...
description: "Import external libraries in Requestly API Client scripts to extend functionality. Use require to add modules like moment, lodash, uuid, and more to customize requests and responses."
---
