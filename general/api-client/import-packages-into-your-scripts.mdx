...
description: "Learn how to import external libraries in Requestly scripts using require to extend functionality with modules like moment, lodash, and uuid."
---
