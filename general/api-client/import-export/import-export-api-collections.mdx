...
<Info>
  **Need Help First?**\
  If you’re new to collections or environments, check out our docs on [creating a collection](/general/api-client/api-collections#create-api-collection) and managing environments before using import/export.
</Info>
...
<Steps>
  <Step title="Download and Open Requestly">
    ...
    <img
      src="/images/import-export-api-collections/d59f3081-bacb-4faf-ac16-9204a7d24627.png"
      align="center"
      fullwidth="false"
    />
  </Step>
  <Step title="Open the Export Option">
    ...
    <img
      src="/images/import-export-api-collections/b2812538-5374-4c10-a643-427a9e44fe05.png"
      align="center"
      fullwidth="false"
    />
  </Step>
  <Step title="Download the Collection File">
    ...
    <img
      src="/images/import-export-api-collections/d8390469-b092-49db-ab22-57981462e9c1.png"
      align="center"
      fullwidth="false"
    />
  </Step>
...
<Steps>
  <Step title="Download and Open Requestly">
    ...
    <img
      src="/images/import-export-api-collections/d92b2015-4f6b-4ddd-b7cc-e7bf8ee39ec7.png"
      align="center"
      fullwidth="false"
    />
  </Step>
  <Step title='Click on "Import"'>
    ...
    <img
      src="/images/import-export-api-collections/adc8ba1b-8e0e-44f9-8f64-29944773e0c1.png"
      align="center"
      fullwidth="false"
    />
  </Step>
  <Step title='Select "Requestly’s Collection & Environment"'>
    ...
    <img
      src="/images/import-export-api-collections/7c1b9f07-fc72-44f8-bddb-08e1fcf54a16.png"
      align="center"
      fullwidth="false"
    />
  </Step>
  <Step title="Upload Your File">
    ...
    <img
      src="/images/import-export-api-collections/747bac68-40b3-4441-926f-af44a518e853.png"
      align="center"
      fullwidth="false"
    />
  </Step>
