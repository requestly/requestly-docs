---
title: 'Import From OpenAPI Spec'
...
The importer supports both **YAML** and **JSON** OpenAPI files.
When you upload a spec, Requestly automatically reads the file and creates API collections and requests based on your defined endpoints.
...
<Steps>
  <Step title="Open the API Client">
    ...
    <img src="/images/import-from-openapi-spec/414a2152-813e-41de-b431-2d5bb26206fa.png" align="left" fullwidth="false" />
  </Step>

  <Step title="Import Your OpenAPI File">
    Click **Import → OpenAPI** and select your `.yaml` or `.json` file.

    <img src="/images/import-from-openapi-spec/08259fe4-3f9d-40b8-8cf3-12061d4eccbd.png" align="center" fullwidth="false" />
  </Step>
  ...
  <Step title="Preview Before Import">
    ...
    * The environments and variables that will be set up
    ...
    <img src="/images/import-from-openapi-spec/09014102-1733-4f1b-b08a-d3222a630f93.png" align="center" fullwidth="false" />
  </Step>
  ...
  <Step title="Requestly builds your collection">
    ...
    * Requestly automatically fills in the **method, URL, headers, and body** (if defined in the spec).
    ...
    <img src="/images/import-from-openapi-spec/d9055f27-0b15-4076-babe-dc2b8e65cd5c.png" align="center" fullwidth="false" />
  </Step>
  ...
  <Step title="Environments are created automatically">
    ...
    * You can switch environments easily from the environment dropdown.
    ...
    <img src="/images/import-from-openapi-spec/e00529b0-d431-4388-97e7-3a63a052fc33.png" align="center" fullwidth="false" />
  </Step>
</Steps>
