...
label: "rq.request"
slug: "rq-request"
description: "Complete reference for the rq.request object in Requestly scripts, including properties and methods to access."
seoDescription: "Learn how to use the rq.request object in Requestly to access request method, headers, body, URL, and query parameters in pre-request and post-response scripts."
visibility: "PUBLIC"
---
