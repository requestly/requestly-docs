...
<CardGroup cols={3}>
  <Card title="Set Up Browser Interception" icon="browser" href="/general/http-interceptor/browser-extension/browser-interception">
    Start intercepting traffic in your browser
  </Card>
  <Card title="Configure Desktop App" icon="desktop" href="/general/http-interceptor/desktop-app">
    Set up system-wide interception with the desktop app
  </Card>
  <Card title="Create HTTP Rules" icon="code" href="/general/http-rules/overview">
