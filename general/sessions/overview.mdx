...
<CardGroup cols={2}>
  ...
  <Card title="Access Control" icon="lock" href="/general/sessions/access-control-of-session">
    Control who can view and use shared sessions.
  </Card>
  <Card title="Inspect Traffic First" icon="magnifying-glass" href="/general/http-interceptor/overview">
