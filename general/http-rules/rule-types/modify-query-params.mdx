...
visibility: "PUBLIC"
format: "MDX"
description: "Learn to modify query parameters in Requestly. Add, remove, or override URL query params with custom rules."
---
...
<Steps>
  ...
  <Step title="Define the Source Condition">
    ...
    * **Operators**: Choose from Regex, Contains, Wildcard, or Equals to apply precise matching logic.
    ...
    For more detailed guidance, refer to the [Source Conditions Guide](/general/http-rules/advanced-usage/advance-targeting).
