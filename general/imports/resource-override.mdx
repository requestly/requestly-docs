...
This becomes a very straightforward setup in Requestly Interceptor. Use the [Redirect Rule](/general/http-rules/rule-types/redirect-rule) with the "Equals" operator.
...
In Requestly Interceptor, you can use the **Redirect Request Rule** with **Redirects to** option as **Pick from Files/Mock Server** and then select the file/create a file that you want to load.
