...
Local workspace in Requestly, like [Team Workspace](https://docs.requestly.com/general/team/how-to-get-started-with-shared-workspace) , is a type of workspace. The key difference is that it stores all your data on your local system, ensuring full privacy for your data. This means your collections, requests, and environment data are stored only on your device and cannot be accessed by anyone else.
