...
<CardGroup cols={2}>
  ...
  <Card title="Capture API Sessions" href="/general/sessions/record-api-sessions" icon="camera">
    Record requests and responses you can analyze, replay, or share.
  </Card>
  <Card title="Create Rules Or Mocks" href="/general/http-rules/overview" icon="wand-magic-sparkles">
