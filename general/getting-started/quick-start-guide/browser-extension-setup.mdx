...
- test APIs without configuring a system proxy
- create HTTP Rules and use the API Client in a browser-first workflow
- capture browser-based debugging context quickly

Use the [Desktop App setup](/general/getting-started/quick-start-guide/desktop-app-setup) instead if you need mobile, emulator, terminal, Node.js, or system-wide interception.

## Recommended Next Steps

<CardGroup cols={2}>
  <Card title="Send Your First API Request" href="/general/api-client/quick-start" icon="paper-plane">
    Start with API Testing if you want a quick first success.
  </Card>
  <Card title="Inspect Browser Traffic" href="/general/http-interceptor/browser-extension/browser-interception" icon="magnifying-glass">
    Learn how interception works inside the browser extension.
  </Card>
  <Card title="Create Your First HTTP Rule" href="/general/http-rules/rule-types" icon="wand-magic-sparkles">
