...
If your goal is to inspect live traffic from an app or browser, start with [HTTP Interceptor](/http-interception/interceptor/overview) instead. If you need to rewrite traffic in-place, use [HTTP Rules](/http-interception/http-rules/overview).
