...
label: "SOAP Requests"
slug: "send-soap"
description: "Learn how to create and send SOAP requests in Requestly using XML bodies, endpoints, and variables."
seoTitle: "Send SOAP Requests - Requestly"
seoDescription: "Step-by-step guide to creating and sending SOAP requests in Requestly. Configure endpoints, add XML body, use variables, and send SOAP over HTTP."
visibility: PUBLIC
---
