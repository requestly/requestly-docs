...
<Tip>
  Not sure which to use? See [Desktop app vs web app](/http-interception/getting-started/difference-between-desktop-app-and-browser-extension).
</Tip>
...
[Full Authorization Guide →](/api-client/authorization)
...
<CardGroup cols={2}>
  <Card title="API Collections Deep Dive" href="/api-client/api-collections" icon="folder-tree">
    Master collection organization and management
  </Card>
  
  <Card title="Variables & Environments" href="/api-client/environments-and-variables" icon="brackets-curly">
    Learn about all variable types and scoping
  </Card>
  
  <Card title="Pre/Post Scripts" href="/api-client/scripts" icon="code">
    Automate your API testing workflow
  </Card>
  
  <Card title="Generate Client Code" href="/api-client/generate-client-code" icon="file-code">
