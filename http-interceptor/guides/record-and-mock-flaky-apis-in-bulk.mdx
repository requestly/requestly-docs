...
1. **Connect an App**: Launch a new app or connect an existing app with Requestly Interceptor to start intercepting network traffic. Learn more [here](https://developers.requestly.com/inspect-traffic/overview/).
